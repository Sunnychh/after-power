...
export const ITEMS: ItemDefinition[] = [
  ...
  { id: 'dish-tomato-rice', name: '锅底番茄焖饭', category: '食物', price: 0, weight: 0.66, description: '酸甜汤汁收进米粒，锅底还留着一层焦香脆壳。', perishableDays: 2, expiredLabel: '已经馊掉', usable: true, effects: { satiety: 48, hydration: 8, morale: 9, stamina: 4 }, tags: ['food', 'cooked'] },
  { id: 'dish-pan-fried-dumplings', name: '应急锅贴', category: '食物', price: 0, weight: 0.54, description: '底面焦脆，上面的皮仍然柔软，油香暂时盖过了封锁线的气味。', perishableDays: 2, expiredLabel: '已经变质', usable: true, effects: { satiety: 47, hydration: -2, morale: 10, stamina: 4 }, tags: ['food', 'cooked'] },
  { id: 'dish-savory-oat-broth', name: '咸味燕麦菌汤', category: '食物', price: 0, weight: 0.62, description: '浓得几乎能立住勺子，香菇和咸味让它勉强算作正餐。', perishableDays: 2, expiredLabel: '已经酸败', usable: true, effects: { satiety: 45, hydration: 13, health: 2, morale: 8 }, tags: ['food', 'cooked'] },
  { id: 'dish-egg-drop-dough', name: '蛋花面疙瘩', category: '食物', price: 0, weight: 0.6, description: '大小不一的面疙瘩浮在蛋花汤里，朴素但很暖胃。', perishableDays: 2, expiredLabel: '已经酸败', usable: true, effects: { satiety: 48, hydration: 12, health: 3, morale: 9 }, tags: ['food', 'cooked'] },
  { id: 'dish-coffee-glazed-meat', name: '咖啡焦边午餐肉', category: '食物', price: 0, weight: 0.32, description: '苦香薄壳裹着咸肉，第一口让人皱眉，第二口竟然有点上瘾。', perishableDays: 2, expiredLabel: '已经发黏', usable: true, effects: { satiety: 35, hydration: -5, morale: 12, stamina: 10 }, tags: ['food', 'cooked'] },
  { id: 'dish-milky-rice', name: '避难所奶香甜饭', category: '食物', price: 0, weight: 0.62, description: '软米饭带着很淡的奶甜味，像一份记不太清的童年点心。', perishableDays: 2, expiredLabel: '已经酸败', usable: true, effects: { satiety: 43, hydration: 8, health: 3, morale: 12 }, tags: ['food', 'cooked'] },
  { id: 'dish-cup-noodle-custard', name: '杯面蛋羹', category: '食物', price: 0, weight: 0.5, description: '碎面埋在多孔蛋羹里，谈不上精致，口感却出奇完整。', perishableDays: 2, expiredLabel: '已经变质', usable: true, effects: { satiety: 43, hydration: 8, health: 2, morale: 9 }, tags: ['food', 'cooked'] },
  { id: 'dish-tomato-baked-beans', name: '番茄焗豆', category: '食物', price: 0, weight: 0.58, description: '酸味渗进豆子，表面烘出一圈微干的浓汁。', perishableDays: 2, expiredLabel: '已经酸败', usable: true, effects: { satiety: 48, hydration: 8, morale: 10, stamina: 4 }, tags: ['food', 'cooked'] },
  { id: 'dish-soft-cracker-pudding', name: '软心饼干布丁', category: '食物', price: 0, weight: 0.4, description: '压缩饼干不再硌牙，奶香和温度把它变成一种末日甜点。', perishableDays: 2, expiredLabel: '已经酸败', usable: true, effects: { satiety: 37, hydration: 4, morale: 13, stamina: 3 }, tags: ['food', 'cooked'] },
  { id: 'dish-coffee-oat-slab', name: '咖啡燕麦砖', category: '食物', price: 0, weight: 0.35, description: '一块结实、微苦又异常提神的深褐色方砖。', perishableDays: 3, expiredLabel: '已经霉变', usable: true, effects: { satiety: 35, hydration: -3, morale: 7, stamina: 13 }, tags: ['food', 'cooked'] },
  { id: 'dish-tomato-steamed-dumplings', name: '番茄汽蒸饺', category: '食物', price: 0, weight: 0.62, description: '浅红色饺子皮吸了番茄汁，酸味让解冻过的馅重新有了精神。', perishableDays: 2, expiredLabel: '已经变质粘连', usable: true, effects: { satiety: 47, hydration: 8, morale: 11, stamina: 4 }, tags: ['food', 'cooked'] },
  { id: 'dish-chocolate-baked-apple', name: '黑巧烤苹果', category: '食物', price: 0, weight: 0.5, description: '软苹果盛着融化的苦甜巧克力，是封锁后少见的正经甜点。', perishableDays: 2, expiredLabel: '已经酸败', usable: true, effects: { satiety: 28, hydration: 8, health: 2, morale: 16 }, tags: ['food', 'cooked'] },
  { id: 'dish-bean-vegetable-soup', name: '豆蔬浓汤', category: '食物', price: 0, weight: 0.72, description: '豆泥让汤变稠，泡开的蔬菜提供了久违的纤维口感。', perishableDays: 2, expiredLabel: '已经酸败', usable: true, effects: { satiety: 52, hydration: 16, health: 3, morale: 10 }, tags: ['food', 'cooked'] },
  { id: 'dish-egg-rice-porridge', name: '酱油蛋花粥', category: '食物', price: 0, weight: 0.7, description: '细蛋花裹着软米粒，酱油的颜色比味道更明显。', perishableDays: 2, expiredLabel: '已经馊掉', usable: true, effects: { satiety: 50, hydration: 15, health: 4, morale: 11 }, tags: ['food', 'cooked'] },
  { id: 'dish-red-three-veg-pot', name: '红汤三蔬锅', category: '食物', price: 0, weight: 0.78, description: '红汤里挤着土豆、番茄和香菇，颜色比食材的新鲜程度热闹得多。', perishableDays: 2, expiredLabel: '已经酸败', usable: true, effects: { satiety: 52, hydration: 17, health: 3, morale: 12, stamina: 4 }, tags: ['food', 'cooked'] },
  { id: 'dish-cracker-bouillon-soup', name: '饼干浓汤', category: '食物', price: 0, weight: 0.54, description: '咸汤和化开的饼干变成一碗稠糊，难看，却比干嚼舒服。', perishableDays: 2, expiredLabel: '已经变味', usable: true, effects: { satiety: 34, hydration: 10, morale: 5 }, tags: ['food', 'cooked'] },
  { id: 'dish-apple-mushroom-broth', name: '苹果香菇汤', category: '食物', price: 0, weight: 0.66, description: '果酸、菌香与咸汤形成一种无法归类的味道，居然让人想再确认一口。', perishableDays: 2, expiredLabel: '已经酸败', usable: true, effects: { satiety: 31, hydration: 20, health: 3, morale: 14 }, tags: ['food', 'cooked'] },
  { id: 'dish-four-supply-stew', name: '四格储备炖锅', category: '食物', price: 0, weight: 0.9, description: '肉、土豆、番茄和蔬菜都煮得很软，一锅足以抵住很长一段夜晚。', perishableDays: 2, expiredLabel: '已经变质', usable: true, effects: { satiety: 68, hydration: 15, health: 4, morale: 15, stamina: 8 }, tags: ['food', 'cooked'] },
  { id: 'dish-soy-mushroom-rice', name: '酱香菌菇焖饭', category: '食物', price: 0, weight: 0.68, description: '每一粒米都带着菌菇和酱油香，锅底还有一点焦脆。', perishableDays: 2, expiredLabel: '已经馊掉', usable: true, effects: { satiety: 50, hydration: 8, morale: 12, stamina: 4 }, tags: ['food', 'cooked'] },
  { id: 'dish-apple-oat-porridge', name: '苹果奶香燕麦粥', category: '食物', price: 0, weight: 0.62, description: '软苹果和奶香让燕麦粥像一份不合时宜的早餐。', perishableDays: 2, expiredLabel: '已经酸败', usable: true, effects: { satiety: 43, hydration: 14, health: 3, morale: 15, stamina: 5 }, tags: ['food', 'cooked'] },
  { id: 'dish-bean-flatbread', name: '豆泥口袋饼', category: '食物', price: 0, weight: 0.5, description: '外皮焦脆，里面是咸软豆泥，拿在手里就能吃。', perishableDays: 3, expiredLabel: '已经霉变', usable: true, effects: { satiety: 48, hydration: -2, morale: 10, stamina: 5 }, tags: ['food', 'cooked'] },
  { id: 'dish-potato-meat-stack', name: '酱油土豆肉塔', category: '食物', price: 0, weight: 0.52, description: '层层叠起的土豆和肉吸满咸汁，形状比味道更精致。', perishableDays: 2, expiredLabel: '已经发黏', usable: true, effects: { satiety: 49, hydration: -3, morale: 11, stamina: 5 }, tags: ['food', 'cooked'] },
  { id: 'dish-tomato-egg-cup', name: '番茄浓汤蛋杯', category: '食物', price: 0, weight: 0.48, description: '酸汤包着松软蛋花，适合在生病时慢慢吃。', perishableDays: 2, expiredLabel: '已经变质', usable: true, effects: { satiety: 36, hydration: 14, health: 5, morale: 11 }, tags: ['food', 'cooked'] },
  { id: 'dish-chocolate-coffee-pudding', name: '咖啡黑巧饼干布丁', category: '食物', price: 0, weight: 0.42, description: '苦、甜、奶香和饼干糊混在一起，像一份灾前咖啡馆失败的新品。', perishableDays: 2, expiredLabel: '已经酸败', usable: true, effects: { satiety: 38, hydration: -2, morale: 20, stamina: 12 }, tags: ['food', 'cooked'] },
  { id: 'dish-dumpling-egg-bake', name: '酱香饺子蛋烘', category: '食物', price: 0, weight: 0.56, description: '饺子馅和蛋液凝成紧实一块，切开后仍然冒着热气。', perishableDays: 2, expiredLabel: '已经变质', usable: true, effects: { satiety: 50, hydration: 5, health: 3, morale: 12, stamina: 5 }, tags: ['food', 'cooked'] },
  { id: 'dish-four-color-soup', name: '四色综合浓汤', category: '食物', price: 0, weight: 0.88, description: '一锅颜色混乱却营养完整的浓汤，每一勺都能捞到不同东西。', perishableDays: 2, expiredLabel: '已经酸败', usable: true, effects: { satiety: 62, hydration: 20, health: 6, morale: 14, stamina: 7 }, tags: ['food', 'cooked'] },
  { id: 'dish-milk-oat-apple-pot', name: '奶香苹果燕麦锅', category: '食物', price: 0, weight: 0.66, description: '温热甜粥在停电后显得格外奢侈。', perishableDays: 2, expiredLabel: '已经酸败', usable: true, effects: { satiety: 45, hydration: 15, health: 3, morale: 16, stamina: 5 }, tags: ['food', 'cooked'] },
  { id: 'dish-soy-meat-noodles', name: '酱油午餐肉汤面', category: '食物', price: 0, weight: 0.62, description: '肉片漂在深色面汤上，是简单但可靠的一大碗。', perishableDays: 2, expiredLabel: '汤面已经酸败', usable: true, effects: { satiety: 52, hydration: 13, morale: 12, stamina: 6 }, tags: ['food', 'cooked'] },
  { id: 'dish-survival-feast', name: '四人份避难所杂烩', category: '食物', price: 0, weight: 0.96, description: '米、蛋、菜和肉挤满整锅，分着吃比独吞更有意义。', perishableDays: 2, expiredLabel: '已经变质', usable: true, effects: { satiety: 72, hydration: 16, health: 6, morale: 18, stamina: 9 }, tags: ['food', 'cooked'] },
