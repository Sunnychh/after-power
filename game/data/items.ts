...
export const ITEMS: ItemDefinition[] = [
  ...
  { id: 'flashlight', name: '强光手电', category: '工具', price: 34, weight: 0.35, description: '大雾中前往细化地点会降低天气风险，也能解锁部分事件解法。', store: 'hardware', tags: ['light', 'explore', 'combo'], easyPlan: { tier: '推荐', target: 1 } },
  { id: 'camp-stove', name: '便携炉头', category: '工具', price: 48, weight: 0.55, description: '停电后的备用炉具；寒潮等事件中可配合燃料制作热食。', store: 'hardware', tags: ['cook', 'combo'] },
  ...
  { id: 'raincoat', name: '厚雨衣', category: '防护', price: 36, weight: 0.65, description: '暴雨或酸雨中前往细化地点会大幅降低天气风险，也能解锁外墙处理。', store: 'hardware', tags: ['protection', 'rain'] },
