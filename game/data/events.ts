...
export const EVENTS: GameEvent[] = [
...

  {
    ...
    text: '夜里有人按三短一长敲防火门。林舟隔着门说，楼下有个孩子发烧，她只需要干净的水。', chain: { id: 'stairwell', step: 1 }, npc: 'lin-zhou', countsAsContact: true,
    options: [
  ...
  },
  {
    ...
    text: '门外放着那只空水瓶，里面卷着一张诊所药柜的简图。林舟在楼道另一头等你的回应。', chain: { id: 'stairwell', step: 2 }, npc: 'lin-zhou', requiresFlags: ['stairwell-helped'], countsAsContact: true,
    options: [
  ...
  },
  {
    ...
    text: '收音机的噪声里插进一个女人的声音：“如果你在河西，记住九十七点三，双数日零点。”', chain: { id: 'signal', step: 1 }, npc: 'qiu-lan', requiresRadio: true, countsAsContact: true,
    options: [
  ...
  },
  {
    ...
    text: '零点，那个声音准时出现。她自称邱岚，说感染数据被人为删改，需要有人保留一份校验码。', chain: { id: 'signal', step: 2 }, npc: 'qiu-lan', requiresRadio: true, requiresFlags: ['qiu-frequency'], countsAsContact: true,
    options: [
      ...
      { label: '要求她先证明身份', hint: '邱岚信任 +5', result: '她报出青禾诊所旧药柜的编号、柜门内侧的划痕和一段过期校验码。这些细节至少可以在之后独立核对。', effects: { relationships: { 'qiu-lan': 5 }, addFlags: ['qiu-verified'] } },
  ...
  },
  {
    ...
    text: '收集雨水时，你听见水箱后有人咳嗽。陈檬从阴影里走出来，口罩已经湿透。', chain: { id: 'rooftop', step: 1 }, npc: 'chen-meng', countsAsContact: true,
    options: [
  ...
  },
  {
    ...
    text: '你发现账本页码跳了一张。潘岳承认，那页记录了封锁前三天有人批量买走防化胶带和低温箱。', chain: { id: 'ledger', step: 2 }, npc: 'pan-yue', requiresFlags: ['ledger-kept'], countsAsContact: true,
    options: [
  ...
  {
    id: 'horde-warning', title: '远处成片的脚步', phase: 'survival', minDay: 6, maxDay: 6, npc: 'chen-meng', countsAsContact: true,
  ...
  {
    id: 'horde-night', title: '尸潮经过长街', phase: 'survival', minDay: 8, maxDay: 8, difficulties: ['easy', 'normal'],
    text: '凌晨两点，玻璃先开始发颤，随后是成百上千的脚步。它们撞上楼下卷闸门，像水挤进狭窄的管道。', chain: { id: 'horde', step: 2 },
    options: [
      { label: '守住楼梯口', hint: '危险：中；加固会降低损失', result: '你和邻居轮流顶住防火门，直到街上的声音移向北边。', countsAsContact: true, danger: 42, effects: { shelter: { integrity: -12 }, stats: { stamina: -18 }, addFlags: ['horde-survived'] } },
...

  {
    ...
    options: [
      ...
      { label: '只收进原水桶，暂不饮用', hint: '待净化原水 +12', result: '你贴上“未处理”的纸条，避免在最渴的时候犯错。', effects: { shelter: { rawWater: 12 } } },
  ...
  },
  {
    ...
    options: [
      ...
      { label: '分给同楼的人', hint: '陈檬信任 +10，精神 +4', result: '食物不多，每个人只分到一小口，但没人抱怨。', countsAsContact: true, effects: { relationships: { 'chen-meng': 10 }, stats: { morale: 4 } } },
  ...
  },
  {
    ...
    options: [
      { label: '大声提醒并协助灭火', hint: '水分 -8，体力 -8，精神 +4', result: '几盆水从不同窗口泼下去，火终于缩回铁桶。', countsAsContact: true, effects: { stats: { hydration: -8, stamina: -8, morale: 4 }, relationships: { 'chen-meng': 4 } } },
  ...
  {
    id: 'battery-trade', title: '隔门的交易', phase: 'survival', minDay: 3, npc: 'chen-meng', countsAsContact: true,
    ...
    options: [
      ...
      { label: '让他用电池证明收音机能响', hint: '需要短波收音机；情报 +1，危险：低', result: '他调到一个民用频道。里面有人在报东郊道路情况。', requirements: [{ item: 'radio', quantity: 1 }], danger: 18, effects: { intel: 1 } },
  ...
  },
  {
    ...
    options: [
      { label: '照着节奏回应', hint: '精神 +5', result: '另一端很快回了三下。你们没有说话，但彼此都在。', countsAsContact: true, effects: { stats: { morale: 5 }, addFlags: ['pipe-contact'] } },
      { label: '敲出求水信号', hint: '瓶装水 +1，欠下人情', result: '半小时后，一瓶水沿楼梯滚到门口，瓶身写着“12F”。', countsAsContact: true, effects: { inventory: { 'water-bottle': 1 }, addFlags: ['owe-floor12'] } },
      { label: '不暴露位置', hint: '精神 -1', result: '敲击持续了几分钟，最终停了。', effects: { stats: { morale: -1 } } },
    ],
  },
  {
    id: 'medicine-request', title: '退烧药清单', phase: 'survival', minDay: 4,
    text: '林舟把一张手写清单塞进来：止痛片、净水、干净布。她说不是为一个人准备的。', npc: 'lin-zhou', countsAsContact: true,
    options: [
  ...
  },
  {
    ...
    options: [
      ...
      { label: '拿盆接住', hint: '完整度 -4，待净化原水 +3', result: '盆里的水不能直接喝，至少没有漫进床底。', effects: { shelter: { integrity: -4, rawWater: 3 } } },
    ],
  },
  {
    ...
    options: [
      ...
      { label: '在楼道提醒所有人别下去', hint: '精神 -3，陈檬信任 +8', result: '有人骂你多事，但最终没有一户开门。', countsAsContact: true, effects: { stats: { morale: -3 }, relationships: { 'chen-meng': 8 } } },
  ...
  },
  {
    ...
    options: [
      ...
      { label: '帮邻居轮流充应急灯', hint: '电力 +3，陈檬信任 +7', result: '一根接线板穿过三户门缝，谁都只充了半小时。', countsAsContact: true, effects: { shelter: { power: 3 }, relationships: { 'chen-meng': 7 } } },
      { label: '晒干被褥和衣服', hint: '精神 +6，健康 +2', result: '太阳味只停留了一晚，也足够珍贵。', effects: { stats: { morale: 6, health: 2 } } },
    ],
  },
  {
    id: 'injured-stranger', title: '门外的血迹', phase: 'survival', minDay: 6, countsAsContact: true,
  ...
  {
    id: 'radio-choir', title: '频道里的合唱', phase: 'survival', minDay: 7, requiresRadio: true, countsAsContact: true,
    ...
    options: [
      ...
      { label: '立即关机，不跟唱', hint: '不追加耗电，精神 -1', result: '九点整，你想象城市里某些窗户正在亮着。', effects: { stats: { morale: -1 } } },
    ],
  },
  {
    ...
    options: [
      { label: '拿密封燃料罐帮忙转装', hint: '燃料 +4，潘岳信任 +4', result: '危险的塑料瓶被清空，对方分给你一点燃料。', countsAsContact: true, requirements: [{ item: 'fuel-can', quantity: 1 }], effects: { shelter: { fuel: 4 }, relationships: { 'pan-yue': 4 } } },
  ...
  },
  {
    ...
    options: [
      ...
      { label: '通知林舟来想办法', hint: '林舟信任 +10，绷带 +1', result: '她带来更长的晾衣杆，药品对半分。', countsAsContact: true, effects: { relationships: { 'lin-zhou': 10 }, inventory: { bandage: 1 } } },
  ...
  {
    id: 'checkpoint-flare', title: '封锁线外的信号弹', phase: 'survival', minDay: 11, npc: 'qiu-lan', requiresRadio: true, countsAsContact: true,
  ...
  {
    id: 'shared-dinner', title: '走廊里的晚饭', phase: 'survival', minDay: 11, npc: 'chen-meng', countsAsContact: true,
    text: '陈檬提议把快过期的东西集中起来，在走廊尽头用一只锅煮掉。门仍各自关着，只留一条缝。',
    options: [
      { label: '贡献一份米和燃料', hint: '米砖 -1，燃料 -3，精神 +12，陈檬信任 +4', requirements: [{ item: 'rice', quantity: 1 }], result: '锅里只有米、豆子和盐，却是封锁以来最像一顿饭的晚饭。', effects: { inventory: { rice: -1 }, shelter: { fuel: -3 }, stats: { morale: 12, satiety: 18 }, relationships: { 'chen-meng': 4 } } },
  ...
  },
  {
    ...
    options: [
      { label: '用备用电力重启水泵', hint: '电力 -4，待净化原水 +14', result: '水压维持了十一分钟。你接满所有标过日期的容器，贴上“未处理”标签，随后立刻关闭总阀。', effects: { shelter: { power: -4, rawWater: 14 }, addFlags: ['pump-restarted'] } },
      { label: '只接自家管道残水', hint: '待净化原水 +5，精神 -3', result: '楼上的人还在拧水龙头时，你已经把自家阀门关上，并把这桶带锈味的水留在待处理区。', effects: { shelter: { rawWater: 5 }, stats: { morale: -3 }, addFlags: ['pump-kept-private'] } },
  ...
  },
  {
    ...
    options: [
      ...
      { label: '按门牌逐户放到门口', hint: '体力 -10，精神 +7', result: '你没有敲门，只把纸箱分完。回程时，有人在门后轻轻说了声谢谢。', countsAsContact: true, effects: { stats: { stamina: -10, morale: 7 }, addFlags: ['delivered-relief-boxes'] } },
  ...
  },
  {
    ...
    options: [
      ...
      { label: '把名单送回隔壁楼', hint: '体力 -8，精神 +5', result: '门缝后伸出一只手接走名单。对方说，他们一直不知道家人被带去了哪里。', countsAsContact: true, effects: { stats: { stamina: -8, morale: 5 }, addFlags: ['returned-quarantine-list'] } },
  ...
  },
  {
    ...
    options: [
      { label: '用绳索送过去两瓶水', hint: '水 -2，绳索不消耗；电池 +1，完整度 +5', result: '装水的袋子沿晾衣绳滑过街面。回来的包里有电池和一块能补窗的防水布。', countsAsContact: true, requirements: [{ item: 'rope', quantity: 1 }, { item: 'water-bottle', quantity: 2 }], danger: 26, effects: { inventory: { 'water-bottle': -2, batteries: 1 }, shelter: { integrity: 5 }, stats: { morale: 6 }, addFlags: ['roof-trade-complete'] } },
      { label: '只回复这里也缺水', hint: '精神 +2', result: '对面熄灯前回了一个“明白”。至少没人会继续浪费电等你。', countsAsContact: true, effects: { stats: { morale: 2 } } },
  ...
  },
  {
    ...
    text: '邱岚说城市的民用中继将在两天后彻底停机。若要把证据发到封锁线外，只剩一次稳定窗口。', npc: 'qiu-lan', requiresRadio: true, countsAsContact: true,
    options: [
  ...
  },
  {
    ...
    options: [
      ...
      { label: '和邻居隔门说话', hint: '精神 +5，中断孤立累计', result: '你们聊了停电前楼下新开的面馆，谁也没提明天。', countsAsContact: true, effects: { stats: { morale: 5 } } },
